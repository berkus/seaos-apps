cd gcc-4.7.1
./configure --host=i586-pc-seaos --prefix=/usr --disable-nls --enable-languages=c,c++ CC_FOR_TARGET=i586-pc-seaos-gcc AR_FOR_TARGET=i586-pc-seaos-ar AS_FOR_TARGET=i586-pc-seaos-as RANLIB_FOR_TARGET=i586-pc-seaos-ranlib STRIP_FOR_TARGET=i586-pc-seaos-strip
